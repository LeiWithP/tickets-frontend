        ...
        <ul className="space-y-2 tracking-wide mt-8">
            ...
            <li>
                <a href="#" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                    ...
                    <span className="group-hover:text-gray-700">Tickets</span>
                </a>
            </li>
            <li>
                <a href="#" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                    ...
                    <span className="group-hover:text-gray-700">Parrillas</span>
                </a>
            </li>
            <li>
                <a href="#" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                    ...
                    <span className="group-hover:text-gray-700">Campañas</span>
                </a>
            </li>
            <li>
                <a href="#" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
